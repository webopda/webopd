    ...
    <div class="container mx-auto px-4">
        <div class="max-w-6xl mx-auto bg-white shadow-lg rounded-2xl overflow-hidden">
            <div class="bg-blue-600 text-white text-center py-4">
                <h2 class="text-2xl font-semibold">Indikator Mutu</h2>
            </div>

            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    @foreach($indmutu as $item)
                        @php
                            $filePath = asset('indikator_mutu/'.$item->indikator_mutu);
                            $extension = strtolower(pathinfo($item->indikator_mutu, PATHINFO_EXTENSION));
