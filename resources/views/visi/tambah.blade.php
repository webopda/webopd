...
<form action="{{ url('admin/visi/tambah') }}" method="post">
@csrf
                <div class="mb-3">
                    <label for="kategori_arsip" class="form-label">visi</label>
                    <input type="text" class="form-control" id="kategori_arsip" name="visi" placeholder="Enter visi" value="{{old('visi')}}" required>
                    @error('visi')
