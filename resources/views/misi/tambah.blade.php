...
<form action="{{ url('admin/misi/tambah') }}" method="post">
@csrf
                <div class="mb-3">
                    <label for="kategori_arsip" class="form-label">Misi</label>
                    <input type="text" class="form-control" id="kategori_arsip" name="misi" placeholder="Enter misi" value="{{old('misi')}}" required>
                    @error('misi')
