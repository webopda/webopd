        ...
        <div class="col-lg-12 col-md-10 col-sm-12">
            <div class="card shadow-lg rounded-4">
                <div class="card-header bg-primary text-white rounded-top-4">
                    <h3 class="mb-0">Tambah organisasi</h3>
                </div>
                <div class="card-body">
                    <form action="{{ url('admin/organisasi/create') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <!-- Sejarah -->
                        <div class="mb-3">
                            <label for="sejarah" class="form-label">Deskripsi Organisasi</label>
                            <textarea name="organisasi" id="sejarah" class="form-control @error('organisasi') is-invalid @enderror">{{ old('organisasi') }}</textarea>
                            @error('organisasi')
